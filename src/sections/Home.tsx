...
const SOCIAL_LINKS: SocialLink[] = [
    {
        ...
        hoverClass: "hover:bg-gray-900 hover:text-white hover:border-gray-900",
        icon: (
...
export default function Home(): ReactElement {
    return (
        ...
        >
            ...
            />
            <motion.div
                className="absolute bottom-20 right-10 w-80 h-80 bg-violet-200 rounded-full blur-3xl opacity-50 pointer-events-none"
                animate={{ scale: [1, 1.2, 1], x: [0, -20, 0] }}
                transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
            />
            <motion.div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink-100 rounded-full blur-3xl opacity-30 pointer-events-none"
